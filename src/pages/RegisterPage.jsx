...
const Login = () => {
    ...
    return (
        <div className=" bg-gray-800 px-20 pb-30 pt-15 rounded-xl shadow-xl w-full max-w-md">
    ...
    render(){
        return (
            <div className="min-h-screen flex items-center justify-center">
                 <img src={registerImage} alt="Movies Background" className='absolute -z-10 w-screen brightness-50'/>
                <Login />
            </div>
        )
    }
