            ...
            <div className="bg-gray-900 p-8 rounded-lg max-w-md w-full mx-4 relative border border-gray-800 animate-jump-in duration-500">
                ...
                <div className="flex flex-col items-center text-center">
                    ...
                    <div className="flex gap-4">
                        <button onClick={() => navigate('/tickets')} className="bg-yellow-400 text-gray-900 px-6 py-2 rounded-lg font-medium hover:bg-yellow-500 ">
                            View Tickets
                        </button>
                        <button onClick={() => navigate('/main')} className="bg-gray-700 text-gray-300 px-6 py-2 rounded-lg font-medium hover:bg-gray-600">
                            Back to Home
                        </button>
                    </div>
                </div>
