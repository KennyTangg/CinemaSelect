                ...
                <div className="flex flex-col items-center text-center">
                    ...
                    <div className="flex gap-4">
                        <button
                            ...
                            className="bg-yellow-400 text-gray-900 px-6 py-2 rounded-lg font-semibold hover:bg-yellow-500 transition-colors duration-200 hover:cursor-pointer"
                        >
                            View Tickets
                        </button>
                        <button
                            onClick={() => navigate('/main')}
                            className="bg-gray-700 text-gray-300 px-6 py-2 rounded-lg font-semibold hover:bg-gray-600 transition-colors duration-200 hover:cursor-pointer"
                        >
                            Back to Home
                        </button>
                    </div>
